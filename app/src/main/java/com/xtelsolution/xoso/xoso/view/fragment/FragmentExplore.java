...
import com.xtelsolution.xoso.xoso.presenter.fragment.FragmentExplorePresenter;
...
import com.xtelsolution.xoso.xoso.view.fragment.inf.IFragmentExplore;
...
public class FragmentExplore extends BasicFragment implements IFragmentExplore, ViewGrid {
    ...
    private void initWidGet(View view) {
        ...
        rcl_explore = view.findViewById(R.id.rcl_explore);
