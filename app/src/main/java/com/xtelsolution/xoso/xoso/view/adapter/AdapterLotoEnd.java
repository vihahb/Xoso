...
import com.xtelsolution.xoso.xoso.model.entity.LotoEnd;
...
public class AdapterLotoEnd extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            tv_label = itemView.findViewById(R.id.tvDuoiLabel);
            tv_value = itemView.findViewById(R.id.tvLotoDuoivalue);
        }
