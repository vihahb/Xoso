...
public class Constants {
    ...
    public static String SOCKET_STREAM = "http://124.158.4.190:3000/";
    public static String SOCKET_MB = "mienbac";

    public static String IS_TO_DAY = "isToday";

    public static final String START_LIVE = "start_live";


    public static long MILIS_OF_24H = 86400000;
