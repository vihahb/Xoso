...
import com.xProject.XosoVIP.xoso.presenter.activity.AnalyticsSpeedActivityPresenter;
...
//        provinceEntityList = new ArrayList<>();
    ...
    @Override
    public void geetSpeedAnalyticsSuccess(List<AnalyticsSetNumber> listSetNumber) {
        startActivity(SpeedListActivity.class, Constants.LIST_SPEED, listSetNumber, Constants.TEMP, temp, Constants.TITLE, 1);
    }
