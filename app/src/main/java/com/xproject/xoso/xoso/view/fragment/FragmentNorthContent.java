...
//    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                viewStub = (ViewStub) view.findViewById(R.id.view_stub_north);
                viewStub.setVisibility(View.VISIBLE);
                rcl_loto_live = (RecyclerView) view.findViewById(R.id.rcl_loto_live);
                ...
                ln_data = (LinearLayout) view.findViewById(R.id.ln_data);
...
//        tv_74.setText("");
    ...
    @Override
    public void setCurrentResult(RESP_Result resp_result) {
        data = resp_result.getData().get(0);
    }
...
//    private void setValueResult(RESP_NewResult newResult) {
//        switch (newResult.getResult_name()){
//            case "res_special":
//                if (newResult.getValue()!=null){
//                    int index = Integer.parseInt(newResult.getIndex());
//                    if (index == 0){
//                        setValueToData(newResult, index);
//                    }
//                }
//                break;
//            case "res_first":
...
//    private void setValueToData(RESP_NewResult newResult, int index) {
//        switch (newResult.getResult_name()){
//            case "res_special":
//                if (data.getRes_special().get(index) == null){
//                    data.getRes_special().set(index, newResult.getValue());
//                } else {
//                    data.getRes_special().remove(index);
//                    data.getRes_special().set(index, newResult.getValue());
//                }
//                break;
//            case "res_first":
//                if (data.getRes_first().get(index) == null){
//                    data.getRes_first().set(index, newResult.getValue());
//                } else {
//                    data.getRes_first().remove(index);
//                    data.getRes_first().set(index, newResult.getValue());
//                }
//                break;
//            case "res_second":
//                if (data.getRes_second().get(index) == null){
//                    data.getRes_second().set(index, newResult.getValue());
//                } else {
//                    data.getRes_second().remove(index);
//                    data.getRes_second().set(index, newResult.getValue());
//                }
//                break;
//            case "res_third":
//                if (data.getRes_third().get(index) == null){
//                    data.getRes_third().set(index, newResult.getValue());
//                } else {
//                    data.getRes_third().remove(index);
//                    data.getRes_third().set(index, newResult.getValue());
//                }
//                break;
//            case "res_fourth":
//                if (data.getRes_fourth().get(index) == null){
//                    data.getRes_fourth().set(index, newResult.getValue());
//                } else {
//                    data.getRes_fourth().remove(index);
//                    data.getRes_fourth().set(index, newResult.getValue());
//                }
//                break;
//            case "res_fifth":
//                if (data.getRes_fifth().get(index) == null){
//                    data.getRes_fifth().set(index, newResult.getValue());
//                } else {
//                    data.getRes_fifth().remove(index);
//                    data.getRes_fifth().set(index, newResult.getValue());
//                }
//                break;
//            case "res_sixth":
//                if (data.getRes_sixth().get(index) == null){
//                    data.getRes_sixth().set(index, newResult.getValue());
//                } else {
//                    data.getRes_sixth().remove(index);
//                    data.getRes_sixth().set(index, newResult.getValue());
//                }
//                break;
//            case "res_seventh":
//                if (data.getRes_seventh().get(index) == null){
//                    data.getRes_seventh().set(index, newResult.getValue());
//                } else {
//                    data.getRes_seventh().remove(index);
//                    data.getRes_seventh().set(index, newResult.getValue());
//                }
//                break;
//        }
