    ...
    private void getData() {
        ...
        if (entity != null) {
            ...
            if (entity.getSpecial() != null && entity.getDate() != null) {
                String loto_special_begin = entity.getSpecial().substring(0, 3);
                String loto_special_end = entity.getSpecial().substring(3);
            ...
            if (entity.getNext_day() != null) {
                adapterToday.refreshData(entity.getNext_day());
            }

            if (entity.getSame_dow() != null) {
                adapterYester_day.refreshData(entity.getSame_dow());
            }
            ...
            if (entity.getSame_day() != null) {
                ...
                adapterAllDayYear.refreshData(entity.getSame_day());
            }
