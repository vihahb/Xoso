...
//                loadComplete.onComplete();
    ...
    private void initTable1(View view) {
        table_1 = (TableLayout) view.findViewById(R.id.south_region_1);
    ...
    private void initTable2(View view) {
        table_2 = (TableLayout) view.findViewById(R.id.south_region_2);
    ...
    private void initTable3(View view) {
        table_3 = (TableLayout) view.findViewById(R.id.south_region_3);
    ...
    private void initTable4(View view) {
        table_4 = (TableLayout) view.findViewById(R.id.south_region_4);
        tvResgion_4 = (TextView) view.findViewById(R.id.tvRegionTitle4);
        tv8_4 = (TextView) view.findViewById(R.id.tv8_4);
        tv7_4 = (TextView) view.findViewById(R.id.tv7_4);
        tv6_1_4 = (TextView) view.findViewById(R.id.tv6_1_4);
        tv6_2_4 = (TextView) view.findViewById(R.id.tv6_2_4);
        tv6_3_4 = (TextView) view.findViewById(R.id.tv6_3_4);
        tv5_4 = (TextView) view.findViewById(R.id.tv5_4);
        tv4_1_4 = (TextView) view.findViewById(R.id.tv4_1_4);
        tv4_2_4 = (TextView) view.findViewById(R.id.tv4_2_4);
        tv4_3_4 = (TextView) view.findViewById(R.id.tv4_3_4);
        tv4_4_4 = (TextView) view.findViewById(R.id.tv4_4_4);
        tv4_5_4 = (TextView) view.findViewById(R.id.tv4_5_4);
        tv4_6_4 = (TextView) view.findViewById(R.id.tv4_6_4);
        tv4_7_4 = (TextView) view.findViewById(R.id.tv4_7_4);
        tv3_1_4 = (TextView) view.findViewById(R.id.tv3_1_4);
        tv3_2_4 = (TextView) view.findViewById(R.id.tv3_2_4);
        tv2_4 = (TextView) view.findViewById(R.id.tv2_4);
        tv1_4 = (TextView) view.findViewById(R.id.tv1_4);
        tvDb_4 = (TextView) view.findViewById(R.id.tvDb_4);

        tvLotoTitle4 = (TextView) view.findViewById(R.id.tvLotoTitle4);
        tvLoto0_4 = (TextView) view.findViewById(R.id.tvLoto0_4);
        tvLoto1_4 = (TextView) view.findViewById(R.id.tvLoto1_4);
        tvLoto2_4 = (TextView) view.findViewById(R.id.tvLoto2_4);
        tvLoto3_4 = (TextView) view.findViewById(R.id.tvLoto3_4);
        tvLoto4_4 = (TextView) view.findViewById(R.id.tvLoto4_4);
        tvLoto5_4 = (TextView) view.findViewById(R.id.tvLoto5_4);
        tvLoto6_4 = (TextView) view.findViewById(R.id.tvLoto6_4);
        tvLoto7_4 = (TextView) view.findViewById(R.id.tvLoto7_4);
        tvLoto8_4 = (TextView) view.findViewById(R.id.tvLoto8_4);
        tvLoto9_4 = (TextView) view.findViewById(R.id.tvLoto9_4);
    }
    ...
    public void setLiveLoto(RESP_LiveLoto liveLoto, int table) {
        switch (table) {
            ...
            case 3:
                ...
                break;
            case 4:
                setBeginLive4(liveLoto.getBegin_with());
                break;
        }
    }
...
//        if ((toDay && TimeUtils.checkTimeInMilisecondNorth(16, 10, 16, 40)) || isLive) {
    ...
    private void setBeginLive4(BeginResult beginResult) {
        /**
         * Dau loto*/
        if (beginResult.getB0().size() > 0) {
            String begin_0 = "";
            ...
            if (begin_0.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp1_b0)) {
                    tmp3_b0 = begin_0;
                    TextUtils.getInstance().setAnimationTextView(tvLoto0_4);
                } else {
                    if (tmp3_b0.length() < begin_0.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto0_4);
                        tmp3_b0 = begin_0;
                    }
                }
        ...
        if (beginResult.getB1().size() > 0) {
            ...
            if (begin_1.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp3_b1)) {
                    tmp3_b1 = begin_1;
                    TextUtils.getInstance().setAnimationTextView(tvLoto1_4);
                } else {
                    if (tmp3_b1.length() < begin_1.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto1_4);
                        tmp3_b1 = begin_1;
                    }
                }
        ...
        if (beginResult.getB2().size() > 0) {
            ...
            if (begin_2.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp3_b2)) {
                    tmp3_b2 = begin_2;
                    TextUtils.getInstance().setAnimationTextView(tvLoto2_4);
                } else {
                    if (tmp3_b2.length() < begin_2.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto2_4);
                        tmp3_b2 = begin_2;
                    }
                }
        ...
        if (beginResult.getB3().size() > 0) {
            ...
            if (begin_3.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp3_b3)) {
                    tmp3_b3 = begin_3;
                    TextUtils.getInstance().setAnimationTextView(tvLoto3_4);
                } else {
                    if (tmp3_b3.length() < begin_3.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto3_4);
                        tmp3_b3 = begin_3;
                    }
                }
        ...
        if (beginResult.getB4().size() > 0) {
            ...
            if (begin_4.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp3_b4)) {
                    tmp3_b4 = begin_4;
                    TextUtils.getInstance().setAnimationTextView(tvLoto4_4);
                } else {
                    if (tmp3_b4.length() < begin_4.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto4_4);
                        tmp3_b4 = begin_4;
                    }
                }
        ...
        if (beginResult.getB5().size() > 0) {
            ...
            if (begin_5.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp3_b5)) {
                    tmp3_b5 = begin_5;
                    TextUtils.getInstance().setAnimationTextView(tvLoto5_4);
                } else {
                    if (tmp3_b5.length() < begin_5.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto5_4);
                        tmp3_b5 = begin_5;
                    }
                }
        ...
        if (beginResult.getB6().size() > 0) {
            ...
            if (begin_6.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp3_b6)) {
                    tmp3_b6 = begin_6;
                    TextUtils.getInstance().setAnimationTextView(tvLoto6_4);
                } else {
                    if (tmp3_b6.length() < begin_6.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto6_4);
                        tmp3_b6 = begin_6;
                    }
                }
        ...
        if (beginResult.getB7().size() > 0) {
            ...
            if (begin_7.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp3_b7)) {
                    tmp3_b7 = begin_7;
                    TextUtils.getInstance().setAnimationTextView(tvLoto7_4);
                } else {
                    if (tmp3_b7.length() < begin_7.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto7_4);
                        tmp3_b7 = begin_7;
                    }
                }
        ...
        if (beginResult.getB8().size() > 0) {
            ...
            if (begin_8.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp3_b8)) {
                    tmp3_b8 = begin_8;
                    TextUtils.getInstance().setAnimationTextView(tvLoto8_4);
                } else {
                    if (tmp3_b8.length() < begin_8.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto8_4);
                        tmp3_b8 = begin_8;
                    }
                }
        ...
        if (beginResult.getB9().size() > 0) {
            ...
            if (begin_9.length() > 0) {
                ...
                if (android.text.TextUtils.isEmpty(tmp3_b9)) {
                    tmp3_b9 = begin_9;
                    TextUtils.getInstance().setAnimationTextView(tvLoto9_4);
                } else {
                    if (tmp3_b9.length() < begin_9.length()) {
                        TextUtils.getInstance().setAnimationTextView(tvLoto9_4);
                        tmp3_b9 = begin_9;
                    }
                }
